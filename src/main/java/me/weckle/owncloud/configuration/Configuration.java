package me.weckle.owncloud.configuration;
...
public class Configuration {
    ...
    public Configuration(Map<String, Object> map, Configuration defaults) {
        this.self = map;
    ...
    private Configuration getSectionFor(String path) {
        ...
        return new Configuration((Map) section, (defaults == null) ? null
                : defaults.getSectionFor(path));
    }
    ...
    public Configuration getSection(String path) {
        ...
        return new Configuration((Map) (get(path, (def instanceof Map) ? def
                : Collections.EMPTY_MAP)), (defaults == null) ? null
    ...
    public int getInt(String path) {
        Object def = getDefault(path);
        return getInt(path, (def instanceof Number) ? ((Number) def).intValue()
                : 0);
    }
    ...
    public List<?> getList(String path) {
        Object def = getDefault(path);
        return getList(path, (def instanceof List<?>) ? (List<?>) def
